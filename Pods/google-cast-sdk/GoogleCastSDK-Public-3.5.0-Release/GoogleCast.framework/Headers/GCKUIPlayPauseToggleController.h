...
#define GCKUIButtonClass NSClassFromString(@"GCKUIPlayPauseToggleController")
#endif
 ...
 * GCKUIButton will not suffice. The application may either subclass this class and override the
 * GCKUIPlayPauseToggleController::playPauseState and GCKUIPlayPauseToggleController::inputEnabled
 * setters, or use KVO to listen for changes to these properties, and update its play/pause UI
 * control(s) accordingly.
 *
 * @since 3.4
 */
GCK_EXPORT
